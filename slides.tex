...
% 8 -- formerly slide 24
\begin{frame}{Household-Level Inflation Dispersion in France}
\centering
{\small\color{WarmGray}French household-level inflation remained widely dispersed within both income groups in 2023.\par}
\vspace{0.15em}
\includegraphics[width=0.96\textwidth,height=0.65\textheight,keepaspectratio]{fig/fig_FR_household_level_inflation_distribution_q1_q5_2023_HBS.png}
\source{Eurostat HICP and French HBS microdata; authors' calculations. Units: 2023 annual household inflation (x) and household share (y), in percent.}
\end{frame}

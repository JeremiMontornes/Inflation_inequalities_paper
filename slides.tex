...
\begin{itemize}
  ...
  \item Group averages conceal substantial within-category heterogeneity: households in the same income quintile can face markedly different inflation rates.
...
\begin{itemize}
  ...
  \item Public HBS data provide consumption baskets by income, age, and residence; microdata add household expenditures, disposable income, and demographics.
...
\small
\begin{itemize}
  \item The counterfactual covers price-policy interventions across all 20 euro-area countries, costing \textbf{EUR 268.9 billion}; \textbf{88\%} of the cost was untargeted.
...
\centering
\includegraphics[width=0.98\textwidth,height=0.72\textheight,keepaspectratio]{fig/slide15_observed_no_policy_q1_q5_gap.pdf}
...
% 8 -- formerly slide 24
\begin{frame}{Households Within the Same Income Quintile Faced Very Different Inflation}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.64\textwidth}
\centering
\includegraphics[width=\textwidth,height=0.62\textheight,keepaspectratio]{fig/slide11_fr_household_inflation_q1_q5_2022.pdf}
\end{column}
\begin{column}{0.33\textwidth}
\vspace{0.6em}
{\large\bfseries\color{Teal}98.9\%\par}
{\small of household-inflation variance lies \textbf{within} income quintiles.\par}
\vspace{1.0em}
{\small
\[
\operatorname{Var}(\pi_h)=4.4595
\]
}
{\footnotesize
\centering
$\underbrace{0.0472}_{\text{between quintiles}}$

$+$

$\underbrace{4.4123}_{\text{within quintiles}}$
\par}
\end{column}
\end{columns}
\source{Eurostat HICP and French HBS microdata; authors' calculations.}
\end{frame}
...
% 17
\begin{frame}{Price Policies Reduced Average Inflation and Inflation Inequality}
\begin{itemize}
  ...
  \item Income-group averages mask substantial household heterogeneity: most inflation dispersion occurs \textbf{within} categories rather than between them.

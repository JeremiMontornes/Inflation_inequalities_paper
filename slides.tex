...
\begin{itemize}
  ...
  \item Household energy contributed \textbf{1.6 points} to the 2022 gap; fuel, transport, and other products offset most of this exposure.
...
% 9
\begin{frame}{Household Energy Drove the 2022 Gap; Other Products Offset It}
\centering
\scriptsize
...
{\small Food kept widening the gap in 2023, but offsets elsewhere brought the aggregate gap back to zero.}
...
% 12
\begin{frame}{Policies Cut the Gap by 0.4 pp in 2022 and 0.5 pp in 2023}
\centering
...
\fcolorbox{Teal}{SoftWhite}{%
  \begin{minipage}{0.82\textwidth}
    \centering
    {\small
    $\text{Policy effect on the gap}=\text{Observed gap}-\text{No-policy gap}$\\[0.25em]
...
% 17
\begin{frame}{The Inflation Gap Was Temporary; Policy Cushioning Persisted}
\begin{itemize}
  ...
  \item Household energy contributed \textbf{1.6 points} to the 2022 gap, while fuel, transport, and other consumption categories offset it.
...
% A2
\begin{frame}{A Uniform Energy Shock Mostly Raises Average Inflation, Not the Gap}
\centering
\scriptsize
\begin{tabular}{lrrrr}
\toprule
...
\vspace{0.5em}
\begin{itemize}
  \item Housing energy widens the gap by \textbf{0.9 point}, but greater Q5 exposure to fuel and transport offsets most of it.
\end{itemize}
...
\vspace{0.7em}
\begin{itemize}
  \item Household energy lowers the gap by \textbf{0.5 point} in both 2022 and 2023; the 2022 fuel effect offsets 0.1 point.
\end{itemize}
...
\vspace{0.8em}
\par\vspace{0.6em}
{\small Negative values indicate that policies reduced inflation or the inflation gap.\par}

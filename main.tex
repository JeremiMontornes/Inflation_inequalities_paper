...
gap by 1.5 points, while their effect through fuel increased the gap by 0.2 point. A complementary input--output
...
measures account for most of the reduction in the Q1--Q5 inflation gap ($-1.00$ point), while fuel
subsidies and rebates increase it by 0.14 point because higher-income households spend more on
private transport. The targeted measures account for $-0.42$ point of the total $-1.22$-point
reduction despite representing EUR 32.8 billion of the EUR 266.9 billion in price support.
...
Slovakia ($-3.0$ points), France ($-2.6$), Portugal ($-1.6$), Greece and Spain ($-1.4$ each),
Croatia and Lithuania ($-1.1$ each), and the Netherlands ($-1.0$). Italy has a policy
...
Counterfactual cumulative inflation is 18.4 percent for Quintile 1 and 16.3 percent for Quintile 5,
compared with observed values of 15.2 and 14.4 percent reported in Table~\ref{tab:country-heterogeneity-cumulative-gap}.
The observed Quintile 1--Quintile 5 gap is therefore 0.9 point, compared with 2.1 points without the
simulated measures. Using unrounded indices, the resulting policy effect is $-1.2$ points.
...
electricity and gas to the Q1--Q5 gap by 1.5 points. Their effect through transport instead increases
...
lower household-energy prices reduce the Q1--Q5 gap by 1.5 points, while lower transport prices

...
cumulative inflation gap between the first and fifth income quintiles is 0.6 point in the
euro area. Over the same period, cumulative inflation for households aged 60 or over exceeds that
...
VAT and charge cuts, fuel rebates, and price caps, lower average cumulative inflation by
1.9 points and reduce the
income-quintile inflation gap by 1.1 points in the euro area.
...
countries. Over 2021--2023, the cumulative Quintile 1--Quintile 5 gap reaches several
points in the Baltic countries and Ireland, but is small in France and Spain. In the euro area, the
cumulative income gap is 0.6 point; the corresponding age and rural--city gaps are 1.3 and 1.0
points. The inflation burden is 3.1, 10.2, and 7.4 percent of net income for the
...
policies lower average cumulative inflation by 1.9 points and reduce the aggregate income-quintile
gap by 1.1 points in the direct index comparison. A complementary input--output
...
rates for the first and fifth income quintiles remain close throughout the 2021--2023
...
reporting the cumulative 2021--2023 inflation gap between the first and fifth income quintiles. The
...
Housing energy and food raise the cumulative Quintile 1--Quintile 5 gap by 2.9 points over
2021--2023, while fuel and transport excluding fuel reduce it by 1.0 point
...
Panel (a) imposes a 30 percent producer-price shock on mining and quarrying, refined petroleum,
electricity, and gas in every euro-area country. Panel (b) imposes a 10 percent shock on agriculture.
Both simulations use the 2022 FIGARO input--output matrix and 2022 HICP, RAS expenditure, and EA20
country weights. The initial shock
...
\input{tables/tab_shock_B_C19_D35_30pct_food10pct_EA20_product_2022}
\endgroup
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Table~\ref{tab:shock-oil-gas-chain-ea20} shows that the shock raises average euro-area inflation by
5.7 percentage points in the 2022 simulation. Household energy contributes 2.2 points, while fuel
and transport excluding fuel contribute 1.0 and 0.7 points. Other products and food contribute
0.7 and 0.5 point. These product contributions combine the sectoral price response from the 2022
FIGARO network with each product's 2022 weight in the relevant household basket. The 10 percent food
shock in panel (b) raises average inflation by 1.0 point but changes the Q1--Q5 gap by only 0.02 point
before rounding.

The distributional effect is concentrated in household energy. The shock raises Q1 inflation through
water, electricity, gas, and other fuels by 2.2 points, compared with 1.5 points for Q5, adding 0.7
point to the Q1--Q5 gap. Higher-income households are more exposed to motor fuels and transport;
these two categories lower the gap by 0.5 and 0.1 point. The total simulated gap is 0.2 point, split
almost equally between direct exposure and indirect production-network propagation. The simulated
gap and the cumulative gap in
Table~\ref{tab:ea20-income-gap-product-contributions} differ in sign and should not be interpreted as a model fit: the
...
directly on prices in the 20 euro-area countries account for EUR 268.0 billion. Of this price-based
support, EUR 235.2 billion is delivered through untargeted measures and EUR 32.8 billion through
...
Administered-price
measures account for most of the reduction in the Q1--Q5 inflation gap ($-0.9$ point). Fuel
subsidies and rebates have a small cumulative effect because their positive effect in 2022 is
largely reversed in 2023. The targeted measures account for $-0.5$ point of the total $-1.1$-point
...
\captionsetup{font=footnotesize, format=hang, singlelinecheck=false, justification=justified}
\caption*{Notes: The no-policy series removes fiscal interventions that directly affected consumer prices. The figure reports year-on-year inflation for all 20 euro-area countries, aggregated with annual HICP country weights, from January 2021 to July 2026. Cumulative policy effects reported in the text cover 2021--2023 and are defined as observed minus no-policy inflation.\\
...
France ($-2.3$ points), Slovakia ($-2.2$), Spain, Portugal, and Greece ($-1.4$ each), and the
Netherlands ($-1.2$). Germany has an effect of $-0.9$ point and Italy $-0.3$ point.
Estimates close to zero arise either where no policy
layer from Appendix~\ref{sec:app-counterfactuals} enters the country row or where temporary
counterfactual price wedges leave little difference in the cumulative 2021--2023 comparison.
...
France combines a reported budget of EUR 80.5 billion with a 2.3-point reduction in the
Q1--Q5 inflation gap, whereas Slovakia combines EUR 2.3 billion with a 2.2-point reduction. These
...
For the euro area, cumulative no-policy inflation is 19.7 percent over 2021--2023, compared with
17.8 percent in the observed index. The observed Quintile 1--Quintile 5 gap is 0.6 point,
compared with 1.8 points without the simulated measures. Using unrounded indices, household price
policies therefore lower average inflation by 1.9 points and the income gap by 1.1 points.
...
gap, together with the annual and cumulative effects of the price measures. The observed and
...
Household energy accounts for the entire displayed cumulative reduction in the income gap
($-1.1$ points). Its annual contribution is $-0.1$ point in 2021 and $-0.5$ point in both 2022 and
2023. The total annual effects across all products are $-0.1$, $-0.4$, and $-0.5$ point,
respectively.
...
across socio-demographic groups in the euro area. Over 2021--2023,
 the cumulative Quintile 1--Quintile 5 gap is 0.6 point, compared with 1.3 points between
...
lower average cumulative inflation by 1.9 points and reduce the aggregate Quintile 1--Quintile 5
gap by 1.1 points in the direct no-policy comparison.

In the policy counterfactual,
the direct index comparison shows that the measures reduce the Q1--Q5 gap by 1.1 points. The product
decomposition assigns this reduction to household energy. The measures lower the retail energy prices to which lower-income households

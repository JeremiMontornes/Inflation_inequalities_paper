...
Water, electricity, gas and other fuels & 7.8 & 9.8 & 6.9 & 2.9 & -1.4\\
\addlinespace
Transport & 2.5 & 1.7 & 3.1 & -1.3 & 0.2\\
Other & 0.3 & 0.2 & 0.4 & -0.1 & 0.0\\
\midrule
\textbf{Total} & \textbf{16.6} & \textbf{18.1} & \textbf{16.1} & \textbf{2.0} & \textbf{-1.1}\\
\bottomrule
\end{tabular}%
}
\vspace{-0.4em}

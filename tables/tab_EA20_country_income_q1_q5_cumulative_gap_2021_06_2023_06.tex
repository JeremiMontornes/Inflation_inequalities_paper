...
\midrule
Germany & 28.1 & 18.5 & 0.5 & -0.4 & 0.9 & 0.4\\
France & 20.4 & 14.6 & 0.7 & 0.3 & 0.1 & 0.1\\
Italy & 16.3 & 18.6 & 1.3 & 0.1 & 1.5 & 0.4\\
...
\vspace{-0.4em}
\begin{flushleft}
\footnotesize{Notes. Cumulative changes compare January 2021 with December 2023; annual rates compare annual-average indices. The gap is Q1 minus Q5. Weights are 2022 EA20 HICP shares. Entries are percentage points. Sources: Eurostat, authors' calculations.}
\end{flushleft}
\end{table}

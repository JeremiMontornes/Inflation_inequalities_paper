...
\vspace{-0.6em}
\begin{flushleft}
\footnotesize{Notes. Entries are shares of annual consumption. Age groups follow Eurostat bands; income rows use the Istat--Eurostat quintile bridge. Sources: Istat and Eurostat HBS, authors' calculations.}
\end{flushleft}
\end{table}
